function f5 = f_hmhr_res_tr(tr, rhor, para)
n(40) = para(8);
n(41) = - para(8);
n(42) = para(9);
n(43) = - para(9);
...
f5 = 0;
for i = 1: 7
    f5 = f5 + n(i) * tt(i) * rhor^d(i) * tr^(tt(i) - 1);
end
for i = 8: 34
    f5 = f5 + n(i) * tt(i) * rhor^d(i) * tr^(tt(i) - 1) * exp(- rhor^c(i));
end
for i = 35: 45
    f5 = f5 + n(i) * rhor^d(i) * tr^tt(i) * exp(- alpha(i) * ...
