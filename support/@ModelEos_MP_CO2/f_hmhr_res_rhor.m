function f4 = f_hmhr_res_rhor(tr, rhor, para)
n(40) = para(8);
n(41) = - para(8);
n(42) = para(9);
n(43) = - para(9);
...
f4 = 0;
for i = 1:7
    f4 = f4 + n(i) * d(i) * rhor^(d(i) - 1) * tr^tt(i);
end
for i = 8:34
    f4 = f4 + n(i) * rhor^(d(i) - 1) * tr^tt(i) * exp(- rhor^c(i)) * ...
        (d(i) - c(i) * rhor^c(i));
end
for i = 35: 45
    f4 = f4 + n(i) * rhor^d(i) * tr^tt(i) * exp(- alpha(i) * ...
