function f16 = f_hmhr_res_2tr(tr, rhor, para)
n(40) = para(8);
n(41) = - para(8);
n(42) = para(9);
n(43) = - para(9);
...
f16 = 0;
for i = 1:7
    f16 = f16 + n(i) * tt(i) * (tt(i) - 1) * rhor^d(i) * tr^(tt(i) - 2);
end
for i = 8:34
    f16 = f16 + n(i) * tt(i) * (tt(i) - 1) * rhor^d(i) * ...
        tr^(tt(i) - 2) * exp(- rhor^c(i));
end
for i = 35: 45
    f16 = f16 + n(i) * rhor^d(i) * tr^tt(i) * exp(- alpha(i) * ...
